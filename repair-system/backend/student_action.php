...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_POST['add_student'])) {
        try {
            ...
            header("Location: ../frontend/student/index.php?status=" . urldecode("เพิ่มข้อมูลเสร็จสิ้น"));
            exit();
...
if (isset($_GET['delete_student'])) {
    try {
        ...
        $stmt->execute([':id' => $id]);
        header("Location: ../frontend/student/index.php?status=" . urldecode("ลบข้อมูลเสร็จสิ้น"));
    } catch (PDOException $e) {
